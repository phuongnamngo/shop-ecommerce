...
return [
     ...
     */
    /*
     * Sanctum SPA uses a session cookie plus CSRF, not Bearer JWT.
     * MiddlewareAuthSecurityStrategy documents auth:* routes with the session cookie.
     */
    'security_strategy' => [
        ...
        [
            ...
            'scheme' => SecurityScheme::apiKey('cookie', 'laravel_session')
                ->as('sessionCookie')
                ->setDescription('Sanctum SPA session cookie.'),
        ],
    ],
];
