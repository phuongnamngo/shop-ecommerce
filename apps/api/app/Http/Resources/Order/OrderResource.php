...
{
    /**
     * @return array{id: int, number: string, status: string, currency: string, subtotal: string, discount_total: string, shipping_total: string, tax_total: string, grand_total: string, shipping_address: array{recipient_name: string, phone: string, province_code: string, district_code: string, ward_code: string, address_line: string, postal_code?: string|null}|null, items?: mixed, status_history?: list<array{from_status: string|null, to_status: string, created_at: string|null}>, created_at: string|null}
     */
